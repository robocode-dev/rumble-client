...
- `design.md` — how the capability works: local design stays close to the criteria it realizes. System structure belongs in `../architecture/README.md`; cross-cutting flows and patterns belong in `../design/README.md`.
